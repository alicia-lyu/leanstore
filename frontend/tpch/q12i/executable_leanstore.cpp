// LeanStore entry point for Q12I workload (skeleton — main() is a no-op).
//
...
//   3. Declare a pipeline_view adapter (q12i_pipeline_view_t).
//   4. Declare the 4-type COLI merged adapter
//      MergedAdapter<customer_coli_t, orders_coli_t, lineitem_coli_t, invoice_coli_t>.
//   5. Initialise LeanStore, construct TPCHWorkload and Q12IWorkload.
//   6. Dispatch on FLAGS_storage_structure via
//      BaseQ12I / ViewQ12I / MergedQ12I / HashQ12I wrappers and

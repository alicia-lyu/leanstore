# Q3I S3 Performance Investigation — Archived 2026-05-03 (cycle 2)

> Archived 2026-05-03, second cycle — superseded by
> [`../PERFORMANCE.md`](../PERFORMANCE.md). Captures A1 + A5 + A2c
> cross-backend evidence trails through commit `88088305`. The first
> archive at [`PERFORMANCE-2026-05-03.md`](PERFORMANCE-2026-05-03.md)
> covers pre-A1 hypothesis history.

This was the **forward-looking** worklist at the time of archival.
Every hypothesis below has already been examined; only their
*status* lives here. For pre-A1 evidence trails, A/B findings, and
reverted optimisations, see
[`PERFORMANCE-2026-05-03.md`](PERFORMANCE-2026-05-03.md).

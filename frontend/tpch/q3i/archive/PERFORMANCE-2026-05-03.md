> **Archived 2026-05-03** — superseded by [`../PERFORMANCE.md`](../PERFORMANCE.md).
> Preserved for hypothesis history (H1–H8 evidence trails, A/B
> findings, reverted optimisations). New active worklist lives in
> the parent file.

// LeanStore entry point for Q9I workload (skeleton — main() is a no-op).
//
...
//   3. Declare a pipeline_view adapter (q9i_pipeline_view_t).
//   4. Declare the 4-type COLI merged adapter
//      MergedAdapter<customer_coli_t, orders_coli_t, lineitem_coli_t, invoice_coli_t>.
//   5. Initialise LeanStore, construct TPCHWorkload and Q9IWorkload.
//   6. Dispatch on FLAGS_storage_structure via
//      BaseQ9I / ViewQ9I / MergedQ9I / HashQ9I wrappers and

...
// Predicate-hoisted: o_orderdate and region/nation filters applied at query
// time. i_status resolved from invoice join at view-load time.
// n_name NOT stored; resolved in the post-pipeline nation equi-join step.

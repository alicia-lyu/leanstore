...
//
// Q3 belongs to the vanilla TPC-H family cohort {Q3, Q5}; see
// q3/executable_rocksdb.cpp header for the family-loader rationale. The
// LeanStore version unifies column-family names ("col_merged" / "col_split_*")
// across q3_btree and q5_btree so a single image directory can serve either
// binary as foreground.
...
{
   gflags::SetUsageMessage("Q3 workload — LeanStore backend (vanilla family)");
   ...
   crm.scheduleJobSync(0, [&]() {
      ...
      // Family-shared COL pipeline names (q3_* / q5_* prefixes dropped so both
      // q3_btree and q5_btree mount the same trees).
      ...
      // S6 shared union view — family-shared name so q3_btree and q5_btree
      // mount the same tree (like col_merged).

// Standalone RandomGenerator implementation for macOS (ROCKSDB_ONLY) builds.
// On Linux these come from backend/leanstore/utils/RandomGenerator.cpp via libleanstore.a.

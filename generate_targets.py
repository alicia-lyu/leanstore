...
exec_names = ["geo_btree", "geo_lsm", "q12_btree", "q12_lsm", "q3i_btree", "q3i_lsm"]
...
class Experiment:
        ...
        for n in STRUCTURE_OPTIONS[self.exec_fname]:
            ...
            if IS_MACOS:
                print(
                    ...
                    "--acoli_projected=$(acoli_projected)",
    ...
    def run_experiment(self) -> None:
        ...
        for structure in [0] + STRUCTURE_OPTIONS[self.exec_fname]:
            ...
            diag_flags = "--micro_perf=$(micro_perf) --cfstats=$(cfstats) --coli_walker_variant=$(coli_walker_variant) --use_seek_skip=$(use_seek_skip) --acoli_projected=$(acoli_projected)"
            if IS_MACOS:
                print(

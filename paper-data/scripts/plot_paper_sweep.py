...
STYLE = {
    "structure_colors": {
        ...
        # S6 shared COL materialised view — darkest of the Mat-View blue
        # family (naive S2 #2980b9, partial-agg id22 #7fb3d5), so it reads as
        # a third Mat-View flavour (one shared view vs the per-query views).
        6: "#1b4f72",
    },

...
dbtoaster/Dockerfile - moved to TRASH/dbtoaster_Dockerfile - folded into the root Dockerfile as a build stage for the vldb26 single-image artifact; separate dbtoaster image no longer needed
